...
class RandomWeightedAverage(_Merge):
    ...
    def _merge_function(self, inputs):
        ...
        return np.column_stack((weights * inputs[0]) + ((1 - weights) * inputs[1]))
...
class GAN():
    ...
    def train(self,images, epochs, output_path, save_interval, data_generator):
        ...
        #averaged_samples = Lambda(self.merge_function)([real_samples[:,:, 1],generated_samples_for_discriminator[:,:,1]])
